...
while True:
    ...
    subprocess.run(["python", "/Users/janyajaiswal/Desktop/ADBMS/MoodSync/MoodSync/ImageCapture.py", str(batch_number)])
    ...
    subprocess.run(["python", "/Users/janyajaiswal/Desktop/ADBMS/MoodSync/MoodSync/spark.py", str(batch_number)])
